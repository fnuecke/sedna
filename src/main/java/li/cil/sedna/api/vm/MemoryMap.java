...
public interface MemoryMap {
     ...
     * @param sizeLog2 the size of the value to read. See {@link li.cil.sedna.api.vm.device.memory.Sizes}.
     ...
     * @param sizeLog2 the size of the value to write. See {@link li.cil.sedna.api.vm.device.memory.Sizes}.
     * @throws MemoryAccessException if an error occurred accessing the memory a the specified location.
     */
